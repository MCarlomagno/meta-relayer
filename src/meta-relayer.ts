import { Relayer, RelayerTransactionPayload } from '@openzeppelin/defender-sdk-relay-signer-client';
...
export class MetaRelayer {
	...
	public async sendTransactionBatch(payloads: RelayerTransactionPayload[], gasLimit?: number) {
		const relayer = this.relayerClients[this.currentIndex];
